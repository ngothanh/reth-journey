...
The series is about *design*, not implementation details. We deliberately skip a few
code-only things (exact function signatures, some `Layout` mechanics, a bit-packing
trick for saving memory). Those reveal themselves once you sit down to write, if you
have the five parts.
